...
\ifcase\boolexpr{ \isequal{\filename}{prot_dpa.dat} \OR \isequal{\filename}{backward.dat} \OR \isequal{\filename}{forward.dat} \OR \isequal{\filename}{nonlinbit.dat}}
	\switch
	...
	\case{\isequal{\currentalgo}{3des2} \OR \isequal{\currentalgo}{3des3}}
		...
		\ifcase\boolexpr{\isequal{\filename}{backward.dat} \OR \isequal{\filename}{forward.dat} \OR \isequal{\filename}{nonlin.dat} }
			\tdesfullbits
		\else
			\tdesbits
		\fi
