 ...
 */
void camellia_encrypt128(const unsigned char __attribute__((key)) *_key, u32 __attribute__((plain)) *_io)
{
    u32 il, ir, t0, t1;
    u32 subkey[128];
   u32 kll, klr, krl, krr;
...
void Camellia_EncryptBlock( const unsigned char* key,
...
int main(int argc,char** argv)
{
  ...
  Camellia_EncryptBlock(key_128,plaintext,scratch);
  if(memcmp(scratch,ciphertext_128,sizeof(ciphertext_128))!=0)
    printf("CAMELLIA-128 test encryption failed.");
    else
	    printf("Ok");
  return 0;
}
